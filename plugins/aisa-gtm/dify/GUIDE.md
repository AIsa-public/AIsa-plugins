...
Run the packaging command from the marketplace repository root. The standalone
upstream publishing workflow is not enabled here. See the
[integration README](../README.md) for source provenance and offline validation.
</details>
